...
xorriso -as mkisofs \
   ...
   -jigdo-jigdo /srv/cdbuilder.debian.org/dst/deb-cd/out/2bullseyeamd64/debian-11.3.0-amd64-NETINST-1.jigdo \
   -jigdo-template /srv/cdbuilder.debian.org/dst/deb-cd/out/2bullseyeamd64/debian-11.3.0-amd64-NETINST-1.template \
